angular.module('moviesApp', [])
  .controller('SearchController', function($scope, $http) {
    ...
    $http.get('https://api.themoviedb.org/3/movie/top_rated?api_key=97d131009d6fad412fe943c626f285d0&language=es-MX&page=1').then(function (response) {
      console.log('te la pelaste paps');
